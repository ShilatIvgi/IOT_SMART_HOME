...
relay_topic = f'trashcan/fillLevel/+'
global ON
ON = False
...
class Mqtt_client(QObject):
    ...
    def on_message(self, client, userdata, msg):
        ...
        self.message_received.emit(topic,m_decode) 
        # mainwin.connectionDock.update_btn_state(topic,m_decode)
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.progress.setRange(0, 100)  # Progress range from 0 to 100
        ...
        formLayot.addRow("ID",self.eID)
        formLayot.addRow("Status",self.progress)
    ...
    def update_btn_state(self,id, value):
        print("update_btn_state",id, value)
        self.eID.setText(id)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.mc.message_received.connect(self.connectionDock.update_btn_state)    
