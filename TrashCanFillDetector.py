...
DHT_topic = f'trashcan/fillLevel/{clientname}'
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.FillLevel=QLineEdit()
        self.FillLevel.setText('')
        ...
        formLayot.addRow("Fill level",self.FillLevel)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('TrashCanFillDetector')        
    ...
    def update_data(self):
        print('Next update')
        fill_level=random.choice(range(0, 101, 5))
        #hum=74+random.randrange(1,25)/10
        # current_data='FillLevel: '+str(fill_level)+' Humidity: '+str(hum)
        self.connectionDock.FillLevel.setText(str(fill_level))
        #self.connectionDock.Humidity.setText(str(hum))
        self.mc.publish_to(DHT_topic,fill_level)
